...
exports.update = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            message: error.message || "Some error occurrred while retrieving quiz",
            data: null,
        });
    }
}
...
// Mengambil data quiz berdasarkan id tertentu
...
// Menampilkan atau mengambil semua data wquiz berdasarkan category tertentu
